...
AutoSequence *Auton::AT_Test_Ultras = AutoSequence::FromTasks(
    vector<AutoTask>{
        ...
        //1 to 2
        TurnToPointTask({24, 70}, 0.07),
        PurePursuitTask({24, 70}, 0, 100).AddRun(IntakeF(200)),
        // Delay(250).AddRun([]{
        //   setDriveSafe(-50, -50);
        // }),
        // Delay(250).AddRun([]{
        //   setDriveSafe(0, 0);
        // }),
        TurnToPointTask({16, 72}, 0.07),

        Delay(200).AddKill([] {
          stopMotors();
        }),
        PurePursuitTask({16, 72}, 0, 100),
        ...
        //   setDriveSafe(0, 0);
        // }),
        TurnToPointTask({13, 133}, 0.07),
        Delay(200).AddKill([] {
          stopMotors();
        }),
        PurePursuitTask({13, 133}, 0, 100),
        ...
        PurePursuitTask({108, 105}, 0, 100).AddInit(IntakeF(200)),
        // Delay(250).AddRun([] {
        //   setDriveSafe(-50, -50);
        // }),
        // Delay(250).AddRun([] {
